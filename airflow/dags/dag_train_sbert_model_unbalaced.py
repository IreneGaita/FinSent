...
def train_sbert_model_unbalanced():
    print(">>> [TRAIN] Inizio training SBERT senza bilanciamento")
    ...
    # Nome esperimento
    experiment_name = "sbert_unbalanced"
    ...
    latest_dir = "/opt/airflow/data/models/sbert_unbalanced_latest"
    ...
    # Vectorizer non salvato
    print(f">>> [TRAIN] Vectorizer SBERT NON salvato (usa all-MiniLM-L6-v2)")
    ...
    config = {
        ...
        "random_state": 42,
        "timestamp": timestamp,
        "vectorizer_name": "all-MiniLM-L6-v2"
    }
...
# DAG
with DAG(
    dag_id="train_sbert_model_dag_unbalanced",
    start_date=datetime(2024, 1, 1),
    schedule_interval=None,
    catchup=False,
    tags=["ml", "train", "sbert", "unbalanced"],
) as dag:

    train_model = PythonOperator(
        task_id="train_sbert_model_unbalanced",
        python_callable=train_sbert_model_unbalanced,
    )
